...
class ProfileWinChallengersAdapter(activity: BaseActivity, var chellenge: ArrayList<ProfileChallengeResult>):
    RecyclerView.Adapter<ProfileWinChallengersAdapter.ViewHolder>(){
