...
class MyFollowingResult {
    private var myFollowingResult: MyFollowingResult? = null
    ...
    @Expose
    var activeChallenge: ActivieChallenge? = null



    var isChecked: Boolean? = null
    var pos:Int? = null
    fun setMyFollowingResult(result: MyFollowingResult?){
        myFollowingResult  = result
    }

    fun getMyFollowingResult(): MyFollowingResult? {
        return myFollowingResult
    }


}

class ActivieChallenge (
    val uid : String,
    val image : String,
    val video : String,
