...
class SignUpResultModel {
    ...
    private var childList: ArrayList<ChildModel>? = null
    ...
    @SerializedName("isOtherFollow")
    @Expose
    var isOtherFollow:Boolean? = null
    ...
    fun setChildList(data: ArrayList<ChildModel>?){
        childList = data
    }
    fun getChildList(): ArrayList<ChildModel>? {
        return childList
    }
}